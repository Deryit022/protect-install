...
echo "🚀 Memasang proteksi Database Admin (hanya Admin ID 1)..."
...
class DatabaseController extends Controller
{
    ...
    private function checkAccess()
    {
        ...
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: hanya admin ID 1 yang dapat mengelola Database! ©Protect By @PutzzOfficial');
        }
    }
...
echo "✅ Proteksi Database Admin berhasil dipasang!"
echo "📂 Lokasi file: $REMOTE_PATH"
echo "🗂️ Backup file lama: $BACKUP_PATH (jika sebelumnya ada)"
echo "🔒 Hanya Admin (ID 1) yang bisa mengelola Database Section."
